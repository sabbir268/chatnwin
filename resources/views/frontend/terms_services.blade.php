...
<div class="terms-services-area">
    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="terms-condition-area text-left">
                <h4>Sneakly Legal</h4>
                <h4>(TERMS)</h4>
                <h2>Privacy Policy for Sneakly</h2>
                <p>At Sneakly, accessible from sneakly.co, one of our main priorities is the privacy of
                    our visitors. This Privacy Policy document contains types of information that is
                    collected and recorded by Sneakly and how we use it.
                </p>
                <p>
                ...
                <p>
                    Sneakly legal basis for collecting and using the personal information described in
                    this Privacy Policy depends on the Personal Information we collect and the
                    specific context in which we collect the information:
                </p>
                <div>
                    <ul>
                        <li>Sneakly needs to perform a contract with you</li>
                        <li>You have given Sneakly permission to do so</li>
                        <li>Processing your personal information is in Sneakly legitimate interests</li>
                        <li>Sneakly needs to comply with the law</li>
                    </ul>
                </div>
                <p>
                    Sneakly will retain your personal information only for as long as is necessary for
                ...
                <p>
                    ...
                    Our Privacy Policy was generated with the help of <a href="https://www.gdprprivacypolicy.net/">GDPR Privacy Policy Generator</a> and the <a href="https://www.app-privacy-policy.com/app-privacy-policy-generator/">App Privacy Policy Generator</a>.
                </p>
                ...
                <h3>Log Files</h3>
                <p>
                    Sneakly follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting
                    ...
                    information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users' movement on the website,
                    and gathering demographic information.
                </p>
                <h3>Cookies and Web Beacons</h3>
                <p>
                    Like any other website, Sneakly uses 'cookies'. These cookies are used to store
                ...
                <p>
                    ...
                    appear on Sneakly, which are sent directly to users' browser. They automatically
                ...
                <p>
                    Note that Sneakly has no access to or control over these cookies that are used by third-party advertisers.
                </p>
                <h3>Third Party Privacy Policies</h3>
                <p>
                    Sneakly's Privacy Policy does not apply to other advertisers or websites. Thus, we
                ...
                <p>
                    Sneakly does not knowingly collect any Personal Identifiable Information from
...
that they shared and/or collect in Sneakly. This policy is not applicable to any
information collected offline or via channels other than this website. <a href="https://www.gdprprivacypolicy.net/">Our GDPR Privacy Policy</a>  was generated from the GDPR Privacy Policy Generator.
                </p>
                <h3>Consent</h3>
