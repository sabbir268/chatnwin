                    ...
                    <div class="row pb-4 text-left">
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="password" name="old_password" class="form-control custom-border-radious">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" class="form-control rounded-4 custom-border-radious">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6">
                            <br><br>
                            <div class="form-group">
                                ...
                                <input type="password" name="password_confirmation" class="form-control custom-border-radious">
                            </div>
                        </div>
                    </div>
                    <hr>
