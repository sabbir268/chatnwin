    ...
    <div class="row">
        <div class="container-fluid">
            <div class="chatroom-inbox-header d-flex justify-content-between">
                ...
                <h1 class="font-weight-bold m-0 p-0">My Account</h1>
            ...
            <form action="{{ url('account/update/'.$user->id) }}" method="POST">
                ...
                <div class="account-area pt-2">
                        ...
                        <div class="row pb-4">
                            <div class="col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="first_name" class="form-control custom-border-radious"
                            ...
                            <div class="col-md-4 col-lg-4 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="last_name" class="form-control custom-border-radious"
                    ...
                    <div class="password-area pt-2">
                        <div class="col-md-12">
                            <h6 class="font-weight-bold mb-3">Password</h6>
                        </div>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" name="old_password"
                                        class="form-control custom-border-radious">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password"
                                        class="form-control rounded-4 custom-border-radious">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6">
                                <br><br>
                            ...
                            <div class="col-md-9 col-lg-9">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label>City</label>
                                            <input type="text" name="city" class="form-control custom-border-radious"
                                                value="{{ $user->city }}">
                                            @error('city')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                ...
                <div class="form-group text-right">
                    <input type="submit"
                        class="btn btn-primary border-sn bg-snw  rounded-0 pl-5 pr-5 pt-3 pb-3 font-weight-bold"
                        value="Save">
                </div>
            </form>
        </div>
